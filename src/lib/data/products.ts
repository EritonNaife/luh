...
export type AnyProduct = Product | Product2;

export interface CartItem {
  productId: string; // Use the product's ID for quick lookups
  quantity: number;
  product: AnyProduct; // The actual product data
}
...
export const products2:Product2[] = [
  {
    id: "torso001",
