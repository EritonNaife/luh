...
aria-labelledby="modal-title">
    ...
    <!-- Content -->
    <div class="flex-1 px-6 py-8 overflow-y-auto text-[#6B6B6B]">
        <form on:submit|preventDefault={handleSignIn} class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    <input
                        ...
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-100 focus:border-gray-100 transition-colors duration-200 {errors.username ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : ''}"
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    <input
                        ...
                        class="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-100 focus:border-gray-100 transition-colors duration-200 {errors.password ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : ''}"
                        disabled={isLoading}
                    />
                    <button
                        type="button"
            ...
            <button
                type="submit"
                disabled={isLoading}
                class="w-full py-3 px-4 bg-black text-white font-medium rounded-lg hover:bg-black/90 focus:ring-4 focus:ring-blue-500/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center space-x-2"
            >
                {#if isLoading}
        ...
        <div class="px-6 py-4 border-t border-gray-100 bg-gray-50">
            <div class="text-center">
                <a 
                    ...
                    class="text-sm text-[#6B6B6B] font-medium hover:text-black transition-colors duration-200 flex items-center justify-center space-x-1"
                    on:click={close}
                >
