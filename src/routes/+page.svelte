...
<main>
    ...
    <section id="Hero-section" class="h-screen w-full " in:fade={{duration: 2000, delay: 50 ,easing: quartOut}}>
        <div class="relative">
    ...
    <section id="Collections-section" class="">
            ...
            <div class="p-2 grid grid-cols-2 lg:flex justify-center lg:gap-5">
