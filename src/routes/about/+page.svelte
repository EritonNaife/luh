...
<main class="w-full mt-[25%] lg:mt-[5%]">
    ...
    <section class="container mx-auto px-6 py-16 lg:py-24 text-center max-w-4xl">
        <h2 class="text-4xl font-light leading-snug tracking-tight mb-4">Turning Moments into Memories</h2>
